import "./ComingAgeCardStyles.css"
import React from "react";
import Packages from "./ComingAgePackages";
...
const ComingAgeCard = () => {
  return (
    ...
    <div className="comingage-container">
        {
            data.map((item, index) => {
                return (
